...
roost_feedback [5/21/2024, 5:20:00 PM]:resolve this error Error generating gradle test report: /private/var/tmp/Roost/RoostGPT/testGradleReport/1716291981/source/gradle-tutorial/src/test/java/com/tomgregory/GradleTutorialAddTwoNumbersTest.java:79: error: cannot find symbol        assertEquals(5, addTwoNumbers(2, 3));
*/
...
public class GradleTutorialAddTwoNumbersTest {
    ...
    private GradleTutorial gradleTutorial = new GradleTutorial();

    @Test
    public void addTwoPositiveNumbers() {
        assertEquals(5, gradleTutorial.addTwoNumbers(2, 3));
    }

    @Test
    public void addPositiveAndNegativeNumbers() {
        assertEquals(-1, gradleTutorial.addTwoNumbers(2, -3));
    }
    ...
    public void addNumberToZero() {
        assertEquals(2, gradleTutorial.addTwoNumbers(2, 0));
    }

    @Test(expected = ArithmeticException.class)
    public void addTwoMaxIntegers() {
        gradleTutorial.addTwoNumbers(Integer.MAX_VALUE, Integer.MAX_VALUE);
    }
}
